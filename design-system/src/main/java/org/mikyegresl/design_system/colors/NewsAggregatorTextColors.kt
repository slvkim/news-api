...
/**
 * Text colors.
 * If there's a Composable with text, then the text must be colored by this palette.
 */
@Stable
class NewsAggregatorTextColors(
    primary: Color,
    secondary: Color,
    tertiary: Color,
    quaternary: Color,
    ...
    fun copy(
        ...
        disabledInverted: Color = this.quaternaryInverted,
        accent: Color = this.accent,
        link: Color = this.link,
        warning: Color = this.warning,
        success: Color = this.success,
        error: Color = this.error
    ): NewsAggregatorTextColors = NewsAggregatorTextColors(
        primary = primary,
        secondary = secondary,
        tertiary = tertiary,
        ...
        quaternaryInverted = disabledInverted,
        accent = accent,
        link = link,
        warning = warning,
        success = success,
    ...
    override fun toString() = buildString {
        appendLine("NewsAggregatorTextColors(")
