 ...
 */
@Stable
class NewsAggregatorDecorativeTextColors(
    pink: Color,
    darkBlue: Color,
    metalGray: Color,
    yellow: Color,
    ...
    ): NewsAggregatorDecorativeTextColors = NewsAggregatorDecorativeTextColors(
        pink = pink,
        darkBlue = darkBlue,
        metalGray = metalGray,
        yellow = yellow,
    ...
    override fun toString() = buildString {
        appendLine("NewsAggregatorDecorativeTextColors(")
