...
/**
 * Decorative muted alt colors.
 */
@Stable
class NewsAggregatorDecorativeMutedAltColors(
    pink: Color,
    darkBlue: Color,
    metalGray: Color,
    yellow: Color,
    ...
    ): NewsAggregatorDecorativeMutedAltColors = NewsAggregatorDecorativeMutedAltColors(
        pink = pink,
        darkBlue = darkBlue,
        metalGray = metalGray,
        yellow = yellow,
    ...
    override fun toString() = buildString {
        appendLine("NewsAggregatorDecorativeMutedAltColors(")
